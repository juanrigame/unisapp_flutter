...
Widget loginDemo(context) {
  return Scaffold(
    backgroundColor: Colors.white,
    appBar: AppBar(
      title: Text("Acceso Unisapp"),
    ),
          ...
          Padding(
            ...
            child: Center(
              child: Container(
                  ...
                  child: Image.asset('asset/images/schedule.png')),
            ),
          ),
          Padding(
            ...
            child: TextField(
              decoration: InputDecoration(
                  ...
                  labelText: 'Matrícula',
                  hintText: 'Introduce una matrícula dada de alta'),
            ),
          ),
          Padding(
